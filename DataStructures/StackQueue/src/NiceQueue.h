#ifndef STACKQUEUE_NICEQUEUE_H
#define STACKQUEUE_NICEQUEUE_H
...
private:
    ...
    // Входной стек
    NiceStack<T> inStack = NiceStack<T>(0);
    // Выходной стек
    NiceStack<T> outStack = NiceStack<T>(0);
