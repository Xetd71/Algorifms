...
#pragma pack(push, 1)
        ...
        public:
            ...
            Header(UShort ord, UShort rs) : order(ord), recSize(rs), sign(VALID_SIGN)
            {
            }
...
#pragma pack(pop)
        ...
        public:
            ...
            *
            ...
            /** \brief Ищет все вхождения переданного элемента \c k и добавляет их в \c keys
             *
             *  Если k - nullptr, будет выброшено соответствующее исключение
             *  \param k искомый элемент
             *  \param keys лист, куда добавляются найденные элементы
             *  \return колличество найденных элементов
             */
