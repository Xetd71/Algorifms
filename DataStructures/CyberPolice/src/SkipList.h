/*
 * \file
 * \brief классы SkipList + NodeSkipListAbstract + NodeSkipList
 * \author Чуев Иван БПИ163
 * \date 12.11.2017
 *              Написан класс SkipList
 *              Добавлена большая тройка (деструктор, конструктор копирования, оператор "=")
...
public:
    ...
    SkipList(const SkipList<Value, Key, numLevels>& obj);

    SkipList<Value, Key, numLevels>& operator=(const SkipList<Value, Key, numLevels>& obj);
